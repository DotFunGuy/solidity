...
// ----
// Warning 9207: (47-69): 'transfer' is deprecated and scheduled for removal in the next breaking version (0.9). It is encouraged to use 'call{value: <amount>}()' instead.
// Warning 9207: (90-108): 'send' is deprecated and scheduled for removal in the next breaking version (0.9). It is encouraged to use 'call{value: <amount>}()' instead.
