...
// SMTIgnoreCex: yes
// ----
// Warning 9207: (96-106): 'transfer' is deprecated and scheduled for removal in the next breaking version (0.9). It is encouraged to use 'call{value: <amount>}()' instead.
